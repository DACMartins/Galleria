    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_KeywordMediaItem", x => new { x.KeywordsId, x.MediaItemsId });
                    table.ForeignKey(
                        name: "FK_KeywordMediaItem_Keywords_KeywordsId",
                        column: x => x.KeywordsId,
                        principalTable: "Keywords",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_KeywordMediaItem_MediaItems_MediaItemsId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_KeywordMediaItem_MediaItemsId",
                table: "KeywordMediaItem",
                column: "MediaItemsId");
